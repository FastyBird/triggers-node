...
final class ConditionsV1ControllerTest extends DbTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../fixtures/Controllers/conditionsRead.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/conditionsCreate.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/conditionsUpdate.php
	 */
	 ...
	 * @param string $fixture
	 *
	 * @dataProvider ./../../../fixtures/Controllers/conditionsDelete.php
	 */
...
$test_case = new ConditionsV1ControllerTest();
$test_case->run();
